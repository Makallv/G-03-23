package com.example.practicaltask2;
        ...
        dialogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                checkbox2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                        if (isChecked) {
                            Toast.makeText(MainActivity.this, "Marks Cimmermanis checked", Toast.LENGTH_SHORT).show();
                        }

                        if (!isChecked) {
                            Toast.makeText(MainActivity.this, "Marks Cimmermanis unchecked", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
