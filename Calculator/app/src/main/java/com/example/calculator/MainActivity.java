...
public class MainActivity extends AppCompatActivity {
    Button button0, button1, button2, button3, button4, button5, button6,
            ...
            buttonMul, button10, buttonC, buttonEqual, memSave, memRead, memClear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        memRead = findViewById(R.id.memRead);
        ...
        memSave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                memoryValue = Float.parseFloat(crunchifyEditText.getText().toString());
            }
        });
        memRead.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                crunchifyEditText.setText(String.valueOf(memoryValue));
            }
        });
